...
class PHActsTrkFitter : public SubsysReco
{
 public:
  ...
  void set_alignment_state_map_name(const std::string& map_name) { _alignment_state_map_name = map_name; }
...
//  SvtxTrackMap* m_seedTracks = nullptr;
  ...
  std::string _alignment_state_map_name = "SvtxAlignmentStateMap";
